  ...
  return (
    <div>
        ...
        <div className={styles.experienceGrid}>
            ...
            <Experience styles = {styles} company = {"Western Developer Society"} logo = {"/WDSLogo.png"} role1 = {"AI Trainer"} date1 = {"June 2024 - Present"} description1a = {"Utilized nextjs to redesign the website of London’s 13th ward Councillor David Ferreira"} description1b = {"Preformed testing on different devices to ensure website was fully responive"}/>
        </div>
    </div>
  )
}
